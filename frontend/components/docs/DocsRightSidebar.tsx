  ...
  return (
    <aside className="hidden w-[300px] shrink-0 lg:block">
      <div className="sticky top-6 max-h-[calc(100vh-3rem)] overflow-y-auto py-8 pr-4">
        {/* Table of Contents */}
        <div className="mb-6">
          <p className="mb-3 text-[11px] font-black uppercase text-[#082033]/50">
            On this page
          </p>
        ...
        <div className="border-t border-black/[0.06] pt-4 pb-2">
          <p className="text-[11px] font-medium text-[#5f6b86]/60">
            ...
            <button
              ...
              className={`flex-1 rounded-lg border px-3 py-1.5 text-[11px] font-bold transition ${
                helpful === "yes"
                  ...
                  : "border-black/[0.1] text-[#5f6b86] hover:border-[#9474ff] hover:text-[#9474ff]"
              }`}
            >
              Yes
            </button>
