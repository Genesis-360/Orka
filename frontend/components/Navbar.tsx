...
export default function Navbar() {
  ...
  return (
    <header ref={navRef} className="relative z-50 mx-auto max-w-360 px-4 sm:px-6 lg:px-8">
      <nav aria-label="Main navigation" className="flex h-18 items-center border-b border-white/12">
        ...
        <div className="ml-auto hidden items-center gap-2 lg:flex">
          ...
          <Link href="/signup" className="inline-flex items-center gap-2 rounded-md bg-violet px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-[#a78cff] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
      ...
      {mobileOpen && (
        <div className="absolute left-4 right-4 top-18 rounded-xl border border-white/12 bg-[#061a2b] p-3 shadow-[0_22px_60px_rgba(0,0,0,0.3)] lg:hidden">
          ...
          <div className="grid grid-cols-2 gap-2 pt-4">
            ...
            <Link href="/signup" onClick={closeAll} className="rounded-md bg-violet px-3 py-2.5 text-center text-sm font-semibold text-white">Explore Platform</Link>
          </div>
        </div>
      )}
    </header>
